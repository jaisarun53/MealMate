...
public class NoodleRecipeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noodle_recipe_list);

        // Set up Toolbar with Back Arrow
        androidx.appcompat.widget.Toolbar toolbar = findViewById(R.id.toolbarNoodleRecipes);
        setSupportActionBar(toolbar);

        if (getSupportActionBar() != null) {
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Noodle Recipes");
        }
        ...
        mealRecipeViewModel.getRecipesByType("Noodle").observe(this, recipes -> {
            if (recipes != null) {
        ...
        recipeAdapter.setOnRecipeClickListener(recipe -> {
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    Intent intent = new Intent(NoodleRecipeList.this, RecipeDetailActivity.class);
    ...
    private void enableSwipeToDelete() {
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(NoodleRecipeList.this, "Recipe deleted", Toast.LENGTH_SHORT).show();
